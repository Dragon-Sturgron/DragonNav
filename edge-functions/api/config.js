...
function cleanConfig(input) {
  ...
  return {
    ...
    settings: {
      ...
      engineColorFollowTheme: settings.engineColorFollowTheme !== false,
      engineSelectedColor: cleanHexColor(settings.engineSelectedColor, "#e9eefb"),
      engineUnselectedColor: cleanHexColor(settings.engineUnselectedColor, "#f7f7f8")
    },
