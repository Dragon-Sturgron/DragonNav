...
const DEFAULT_CONFIG = {
  ...
  categories: [
    { id: "ai", name: "AI 工具", enabled: true },
    { id: "dev", name: "开发与代码", enabled: true },
    { id: "cloud", name: "云服务与部署", enabled: true },
    { id: "office", name: "日常办公", enabled: true },
    { id: "media", name: "影音与社区", enabled: true },
    { id: "tools", name: "实用工具", enabled: true }
  ],
  sites: [
    { id: "chatgpt", name: "ChatGPT", url: "https://chatgpt.com/", desc: "OpenAI AI 助手", icon: "", categoryId: "ai", enabled: true },
    { id: "deepseek", name: "DeepSeek", url: "https://chat.deepseek.com/", desc: "DeepSeek AI 助手", icon: "", categoryId: "ai", enabled: true },
    { id: "yuanbao", name: "腾讯元宝", url: "https://yuanbao.tencent.com/", desc: "腾讯 AI 助手", icon: "", categoryId: "ai", enabled: true },
    { id: "gemini", name: "Gemini", url: "https://gemini.google.com/", desc: "Google AI 助手", icon: "", categoryId: "ai", enabled: true },
    { id: "github", name: "GitHub", url: "https://github.com/", desc: "代码托管与协作", icon: "", categoryId: "dev", enabled: true },
    { id: "gitee", name: "Gitee", url: "https://gitee.com/", desc: "国内代码托管平台", icon: "", categoryId: "dev", enabled: true },
    { id: "mdn", name: "MDN", url: "https://developer.mozilla.org/zh-CN/", desc: "Web 开发文档", icon: "", categoryId: "dev", enabled: true },
    { id: "stackoverflow", name: "Stack Overflow", url: "https://stackoverflow.com/", desc: "开发者问答社区", icon: "", categoryId: "dev", enabled: true },
    { id: "edgeone", name: "EdgeOne Makers", url: "https://pages.edgeone.ai/", desc: "Tencent EdgeOne 部署平台", icon: "", categoryId: "cloud", enabled: true },
    { id: "tencentcloud", name: "腾讯云", url: "https://cloud.tencent.com/", desc: "腾讯云控制台与服务", icon: "", categoryId: "cloud", enabled: true },
    { id: "cloudflare", name: "Cloudflare", url: "https://dash.cloudflare.com/", desc: "CDN、DNS 与网络服务", icon: "", categoryId: "cloud", enabled: true },
    { id: "vercel", name: "Vercel", url: "https://vercel.com/", desc: "前端应用部署平台", icon: "", categoryId: "cloud", enabled: true },
    { id: "docsqq", name: "腾讯文档", url: "https://docs.qq.com/", desc: "在线文档与表格", icon: "", categoryId: "office", enabled: true },
    { id: "feishu", name: "飞书", url: "https://www.feishu.cn/", desc: "协同办公平台", icon: "", categoryId: "office", enabled: true },
    { id: "wps", name: "WPS", url: "https://www.wps.cn/", desc: "办公软件与云文档", icon: "", categoryId: "office", enabled: true },
    { id: "notion", name: "Notion", url: "https://www.notion.so/", desc: "知识库与笔记", icon: "", categoryId: "office", enabled: true },
    { id: "bilibili", name: "哔哩哔哩", url: "https://www.bilibili.com/", desc: "视频与社区", icon: "", categoryId: "media", enabled: true },
    { id: "youtube", name: "YouTube", url: "https://www.youtube.com/", desc: "在线视频平台", icon: "", categoryId: "media", enabled: true },
    { id: "zhihu", name: "知乎", url: "https://www.zhihu.com/", desc: "中文问答社区", icon: "", categoryId: "media", enabled: true },
    { id: "weibo", name: "微博", url: "https://weibo.com/", desc: "社交媒体平台", icon: "", categoryId: "media", enabled: true },
    { id: "speedtest", name: "Speedtest", url: "https://www.speedtest.net/", desc: "网络速度测试", icon: "", categoryId: "tools", enabled: true },
    { id: "ipsb", name: "IP 查询", url: "https://ip.sb/", desc: "查看当前公网 IP", icon: "", categoryId: "tools", enabled: true },
    { id: "caniuse", name: "Can I Use", url: "https://caniuse.com/", desc: "浏览器兼容性查询", icon: "", categoryId: "tools", enabled: true },
    { id: "tinypng", name: "TinyPNG", url: "https://tinypng.com/", desc: "在线图片压缩", icon: "", categoryId: "tools", enabled: true }
  ],
  searchEngines: [
    ...
    { id: "sogou", name: "搜狗", url: "https://www.sogou.com/web?query={q}", icon: "https://www.sogou.com/favicon.ico", enabled: true },
    { id: "duck", name: "DuckDuckGo", url: "https://duckduckgo.com/?q={q}", icon: "https://duckduckgo.com/favicon.ico", enabled: true }
  ]
};
...
function cleanSearchEngines(input) {
  ...
  source.forEach((e, i) => {
    ...
    try { const u = new URL(checkUrl); if (!["http:", "https:"].includes(u.protocol)) url = ""; } catch { url = ""; }
    if (!url) return;
    if (icon) {
    ...
    used.add(id);
    out.push({ id, name: String(e?.name || "未命名搜索").slice(0, 80), url, icon, enabled: e?.enabled !== false });
  });
